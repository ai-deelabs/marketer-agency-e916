...
Full-bleed horizontal scroll with pinned side navigation and overlapping card stacks — Compressed grotesque headlines (tight tracking) paired with mono-spaced body text — Bold duotone: concrete white #F0EEE9 + signal orange #FF4D1C, deep charcoal #1A1A1A for structure — Kinetic/systems-thinking energy, like a 2000s Bloomberg terminal crossed with a Tokyo street poster
